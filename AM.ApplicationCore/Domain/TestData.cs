...
namespace AM.ApplicationCore.Domain
{
    ...
    {
        public static Plane BoingPlane = new Plane { PlaneType = PlanType.Boing, Capacity = 150, ManifactureDate = new DateTime(2015, 02, 03) };
        public static Plane Airbusplane = new Plane { PlaneType = PlanType.Airbus, Capacity = 250, ManifactureDate = new DateTime(2020, 11, 11) };
       ...
       ,
        ...
        public static Flight flight7 = new Flight { FlightDate = new DateTime(2022, 07, 01, 20, 10, 10), Destination = "wiem", EffectiveArrival = new DateTime(2022, 06, 01, 22, 30, 10), EstimatedDuration = 200, Plane = Airbusplane };

        //test list
        public static List<Flight> listFlights = new List<Flight> { flight1, flight2, flight3, flight4, flight5, flight6,flight7 };
    }
}
